...
const DEFAULT_STEPS = [
  {
    ...
    imagePath: `${process.env.NEXT_PUBLIC_API_URL || 'http://127.0.0.1:8000'}/media/images/dates.jpg`
  },
  {
    ...
    imagePath: `${process.env.NEXT_PUBLIC_API_URL || 'http://127.0.0.1:8000'}/media/images/vision.jpg`
  },
  {
    ...
    imagePath: `${process.env.NEXT_PUBLIC_API_URL || 'http://127.0.0.1:8000'}/media/images/details.jpg`
  },
  {
    ...
    imagePath: `${process.env.NEXT_PUBLIC_API_URL || 'http://127.0.0.1:8000'}/media/images/settle.jpg`
  }
];
        ...
        <div className="steps-grid">
          {displaySteps.map((step, index) => {
            const imgUrl = step.image?.url
              ? (step.image.url.startsWith('http') ? step.image.url : `${process.env.NEXT_PUBLIC_API_URL || `${process.env.NEXT_PUBLIC_API_URL || 'http://127.0.0.1:8000'}`}${step.image.url}`)
